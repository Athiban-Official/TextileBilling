 ...
 * @author Fatmicky
 */
public class BillingProductsData extends javax.swing.JFrame {

    /**
     * Creates new form BillingProductsData
     */
    public BillingProductsData() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableBilling.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill Id", "Product Name", "Product Qty", "Product Amt"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillingProductsData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BillingProductsData().setVisible(true);
            }
        });
    }
